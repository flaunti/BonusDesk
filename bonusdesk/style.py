...
QLabel#muted, QLabel#pageSubtitle { color: #66758a; }
QLabel#periodPreview { color: #245e9e; background: #eaf3fe; border: 1px solid #c9def8; border-radius: 9px; padding: 10px 12px; font-weight: 650; }
...
QLineEdit, QTextEdit, QComboBox, QSpinBox, QDateEdit { background: #ffffff; border: 1px solid #cfd9e5; border-radius: 7px; padding: 7px; color: #162033; selection-background-color: #bdd4ff; selection-color: #10243e; }
QLineEdit:focus, QTextEdit:focus, QComboBox:focus, QSpinBox:focus, QDateEdit:focus { border: 1px solid #2563eb; }
